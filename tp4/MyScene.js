...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        //Cube textures 
        this.cubeTexSide = new CGFtexture(this, 'images/mineSide.png');
        this.cubeTexTop = new CGFtexture(this, 'images/mineTop.png');
        this.cubeTexBot = new CGFtexture(this, 'images/mineBottom.png');
        this.cube = new MyUnitCubeQuad(this, this.cubeTexTop, this.cubeTexSide, this.cubeTexSide, this.cubeTexSide, this.cubeTexSide, this.cubeTexBot);
        ...
        this.scaleFactor = 5; //default é 5
