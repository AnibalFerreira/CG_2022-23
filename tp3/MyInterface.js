...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'lightIntensity', 0.1, 1.0).onChange(this.scene.updateLightIntensity.bind(this.scene));
        ...
        this.gui.add(this.scene, 'lightFactor', 0.1, 1).name('Global Light');
