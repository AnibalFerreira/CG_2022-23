...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Purple Specular (no ambient, no diffuse)
        this.material8 = new CGFappearance(this);
        this.material8.setAmbient(0, 0, 0, 1.0);
        this.material8.setDiffuse(0, 0, 0, 1.0);
        this.material8.setSpecular(0.62, 0.12, 0.94, 1.0);
        this.material8.setShininess(10.0);    

        // Orange Specular (no ambient, no diffuse)
        this.material9 = new CGFappearance(this);
        this.material9.setAmbient(0, 0, 0, 1.0);
        this.material9.setDiffuse(0, 0, 0, 1.0);
        this.material9.setSpecular(1, 0.65, 0, 1.0);
    ...
    display() {
        ...
        //Comment the next 2 lines to stop displaying both lights
        //this.lights[0].update();
        //this.lights[1].update();
        ...
        this.popMatrix();
/*
        // Code to rotate and display 
        this.pushMatrix();
        this.translate(0,1,0);
        this.rotate(Math.PI/2, 1, 0, 0);
        this.prism.display();
        if (this.displayNormals) this.prism.enableNormalViz();
